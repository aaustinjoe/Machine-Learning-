...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  4 22:44:06 2019
...
path1 = '/home/austin/Desktop/augmentated'    #path of folder of images 
path2 = '/home/austin/Desktop/output'  #path of folder to save images 
...
immatrix = []
#for lal in imlist:
    #images_LIST = os.listdir(lal)
from matplotlib.image import imread
    
for image in imlist:
    im1 = imread(path2 + '/' + image)# open one image to get size
    immatrix.append(im1)
...
#%%
i = 100
plt.imshow(X_train[0].reshape(128,128), interpolation='nearest')
...
target_names = ['class 0(MODI)', 'class 1(ZUK)']
